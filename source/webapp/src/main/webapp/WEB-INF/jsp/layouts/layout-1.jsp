...
<div>
    <ul class="w3-hide-small w3-navbar w3-large w3-theme-dark w3-left-align" style="position: fixed; top:0px; width:100%; z-index: 10;">
        ...
        <li role="ROLE_USER" style="display:none"><a class="w3-padding-16 w3-hover-white" href="my_work_plan.tiles"><i class="fa fa-calendar"></i> Мой план работ</a></li>
...
<header class="w3-container w3-theme w3-padding" id="mainHeader" style="margin-top:56px; width:100%">
    <div class="w3-padding-24 w3-center">
        <h4>КОГДА РАБОТА В САДУ В УДОВОЛЬСТВИЕ</h4>
        <h1 class="w3-xxxlarge">ПЛАНИРОВЩИК САДОВЫХ РАБОТ</h1>
        <div class="w3-padding-16">
            <button class="w3-btn w3-xlarge w3-theme-dark w3-hover-white" onclick="doAction(startPlannerWizard);" style="font-weight:900;">НАЧАТЬ</button>
        </div>
    </div>
</header>
